...
class JadwalTenagaKesehatanSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //Dokter 21
        TenagaKesehatan::find(21)->rumahSakits()->attach(26,[
            'jam' => 'Selasa 11:00 - 14:00',
            'tarif_konsultasi' => '50.000',
            'tarif_buat_janji' => '-',
        ]);
        TenagaKesehatan::find(21)->rumahSakits()->attach(26,[
            'jam' => 'Kamis & Sabtu 07:30 - 09:00',
            'tarif_konsultasi' => '50.000',
            'tarif_buat_janji' => '-',
        ]);

        //Dokter 22
        TenagaKesehatan::find(22)->rumahSakits()->attach(2,[
        ...
        //Dokter 23
        TenagaKesehatan::find(23)->rumahSakits()->attach(24,[
            'jam' => 'Senin - Kamis 07:30 - 12:00',
            'tarif_konsultasi' => '50.000',
            'tarif_buat_janji' => '-',
        ]);
        TenagaKesehatan::find(23)->rumahSakits()->attach(24,[
            'jam' => 'Jumat 07:30 - 10:00',
            'tarif_konsultasi' => '50.000',
            'tarif_buat_janji' => '-',
        ]);
        TenagaKesehatan::find(23)->rumahSakits()->attach(24,[
            'jam' => 'Sabtu 07:30 - 11:00',
            'tarif_konsultasi' => '50.000',
            'tarif_buat_janji' => '-',
        ]);
        ...
        //Jenis 3
        //Dokter 24
        TenagaKesehatan::find(24)->rumahSakits()->attach(8,[
            'jam' => '16:00 - 18:00',
            'tarif_konsultasi' => '50.000',
        ...
        //Dokter 25
        TenagaKesehatan::find(25)->rumahSakits()->attach(4,[
            'jam' => '16:00 - 17:30',
            'tarif_konsultasi' => '50.000',
            'tarif_buat_janji' => '55.000',
        ]);
        TenagaKesehatan::find(25)->rumahSakits()->attach(3,[
            'jam' => '14:00 - 15:00',
            'tarif_konsultasi' => '50.000',
            'tarif_buat_janji' => '55.000',
        ]);
        ...
        //Dokter 26
        TenagaKesehatan::find(26)->rumahSakits()->attach(1,[
            'jam' => '17:30 - 19:30',
            'tarif_konsultasi' => '50.000',
            'tarif_buat_janji' => '145.000',
        ]);
        ...
        //Dokter 27
        TenagaKesehatan::find(27)->rumahSakits()->attach(23,[
            'jam' => '14:00 - 16:00',
            'tarif_konsultasi' => '50.000',
            'tarif_buat_janji' => ' ',
        ]);
        ...
        //Dokter 28
        TenagaKesehatan::find(28)->rumahSakits()->attach(1,[
            'jam' => ' ',
            'tarif_konsultasi' => '50.000',
            'tarif_buat_janji' => ' ',
        ]);
        ...
        //Dokter 29
        TenagaKesehatan::find(29)->rumahSakits()->attach(9,[
            'jam' => '17.00',
            'tarif_konsultasi' => '50.000',
            'tarif_buat_janji' => ' ',
        ]);
        ...
        //Dokter 30
        TenagaKesehatan::find(30)->rumahSakits()->attach(27,[
            'jam' => '11.00',
            'tarif_konsultasi' => '50.000',
            'tarif_buat_janji' => ' ',
        ]);
        ...
        //Dokter 31
        TenagaKesehatan::find(31)->rumahSakits()->attach(10,[
            'jam' => ' ',
            'tarif_konsultasi' => '50.000',
            'tarif_buat_janji' => ' ',
        ]);
        ...
        //Dokter 32
        TenagaKesehatan::find(32)->rumahSakits()->attach(11,[
            'jam' => '09:00 - 11:00',
            'tarif_konsultasi' => '50.000',
            'tarif_buat_janji' => ' ',
        ]);
        ...
        //Dokter 33
        TenagaKesehatan::find(33)->rumahSakits()->attach(12,[
            'jam' => ' ',
            'tarif_konsultasi' => '50.000',
            'tarif_buat_janji' => ' ',
        ]);
        ...
        //Dokter 34
        TenagaKesehatan::find(34)->rumahSakits()->attach(13,[
            'jam' => ' ',
            'tarif_konsultasi' => ' ',
            'tarif_buat_janji' => ' ',
        ]);
        ...
        //Jenis 4
        //Dokter 35
        TenagaKesehatan::find(35)->rumahSakits()->attach(24,[
            'jam' => 'Senin - Kamis 07:30 - 12:00',
            'tarif_konsultasi' => ' ',
            'tarif_buat_janji' => ' ',
        ]);
        ...
        //Jenis 5
        //Dokter 39
        TenagaKesehatan::find(39)->rumahSakits()->attach(2,[
            'jam' => 'Senin & Jumat 09.00 - selesai',
        ...
        TenagaKesehatan::find(40)->rumahSakits()->attach(2,[
            'jam' => 'Kamis 11.00- 13.00',
            'tarif_konsultasi' => '30.000',
            'tarif_buat_janji' => ' ',
        ]);
        
        //Dokter 41
        TenagaKesehatan::find(41)->rumahSakits()->attach(14,[
            'jam' => 'Selasa 08.00- 14.00',
            'tarif_konsultasi' => '30.000',
            'tarif_buat_janji' => ' ',
        ]);
        TenagaKesehatan::find(41)->rumahSakits()->attach(14,[
            'jam' => 'Kamis 07.00- 14.00',
            'tarif_konsultasi' => '30.000',
            'tarif_buat_janji' => ' ',
        ]);
        
        //Dokter 42
        TenagaKesehatan::find(42)->rumahSakits()->attach(12,[
            'jam' => 'Senin - Sabtu 08.30- 13.30',
            'tarif_konsultasi' => '30.000',
            'tarif_buat_janji' => ' ',
        ]);
        
        //Dokter 43
        TenagaKesehatan::find(43)->rumahSakits()->attach(19,[
            'jam' => 'Senin - Sabtu 09.00 - selesai',
            'tarif_konsultasi' => '30.000',
            'tarif_buat_janji' => ' ',
        ]);
        
        //Dokter 44
        TenagaKesehatan::find(44)->rumahSakits()->attach(20,[
            'jam' => 'Senin - Kamis 08.00- 12.00',
            'tarif_konsultasi' => '30.000',
            'tarif_buat_janji' => ' ',
        ]);
        
        //Dokter 45
        TenagaKesehatan::find(45)->rumahSakits()->attach(20,[
            'jam' => 'Jumat 09.30- 13.00',
            'tarif_konsultasi' => '30.000',
            'tarif_buat_janji' => ' ',
        ]);
        
        //Dokter 46
        TenagaKesehatan::find(46)->rumahSakits()->attach(21,[
            'jam' => 'Rabu 09.00- 11.00',
            'tarif_konsultasi' => '30.000',
            'tarif_buat_janji' => ' ',
        ]);
        
        //Dokter 47
        TenagaKesehatan::find(47)->rumahSakits()->attach(22,[
            'jam' => 'Senin - Jumat 10.00- 13.00',
            'tarif_konsultasi' => '30.000',
            'tarif_buat_janji' => ' ',
        ]);
        
        //Dokter 48
        TenagaKesehatan::find(48)->rumahSakits()->attach(24,[
            'jam' => 'Senin - Kamis 07.30- 12.00',
            'tarif_konsultasi' => '30.000',
            'tarif_buat_janji' => ' ',
        ]);
