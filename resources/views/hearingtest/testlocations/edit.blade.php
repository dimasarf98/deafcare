        ...
        <form method="POST" action="{{route('deafcare.tespendengaran.admin.jenis.hearingcenter.store', $jenis->id)}}" class="row" enctype="multipart/form-data">
            ...
            <div class="col-12">
                <x-inputs.select
                    ...
                    :value="$hearingCenter->jenises->map(fn($j)=>$j->id)"
                ...
                ></x-inputs.file-input>
                <hr>
                <schedule-list-hearing-test :jadwal-sekarang="{{$hearingCenter->jadwals}}"></schedule-list-hearing-test>
