        ...
        <div class="row mb-3">
            <div class="col-12">
                <div class="btn-group w-100" role="group" aria-label="Category">
                    <a href="{{route('deafcare.event.index')}}" class="btn btn-danger">Event</a>
                    <a href="{{route('deafcare.donasi.index')}}" class="btn btn-outline-danger">Donasi</a>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                @foreach ($events as $event)
                    ...
                    <div class='card rounded-xl link-style-none mb-3' href="{{route('event.show')}}">
                        <div class="card-body d-flex">
                            <img class="rounded mr-3" src="{{ $event->gambar ?? asset('img/dummy.jpg') }}" alt="..."
                            ...
                            <div class="flex-fill d-flex flex-column justify-content-between" style="min-width: 0">
                                <div>
                                    <div class="font-weight-bold mb-1 text-truncate text-dark" style="line-height:1rem">
                                        <a class="text-dark" href="{{route('deafcare.event.show', $event->id)}}">
                                            {{$event->name}}
                                        </a>
